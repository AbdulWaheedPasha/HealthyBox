...
<div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control" name="price" onkeypress="return isNumber(event)"  step=".01" >
            </div>

            <div class="form-group">
                <label> <?php echo $languages['program']['discount']; ?>
                </label>
                <input class="form-control" name="discount" onkeypress="return isNumber(event)" step=".01" >
            </div>
