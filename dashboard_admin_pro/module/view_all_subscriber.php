...
<script>
    ...
    //             html: "<?php //echo $languages['order']['renew_question']; ?></b>",
    //             ok: function() {
    //                 $.ajax({
    //                     type: 'POST',
            ...
            <table id="sub" class="table table-hover ddtf-processed">
                ...
                <tbody>
                    ...
                    while ($arr = mysqli_fetch_array($rs)) {
                        ...
                        $acive = "";
                        $delete_str = "";
                        // $start_date = strtotime($arr['start_date']);  
                        // $end_date  = strtotime($arr['end_date']);  
                        date_default_timezone_set('Asia/Kuwait');
                        $current_date = date('Y-m-d')." 00:00:00";
                        // echo $current_date;
                        // // $diff = ($end_date - $current_date )/60/60/24;
                         $diff =  0;
                       ...
                       // echo $day_num_sql."<br/>";
                        ...
                        } else if ($arr['administration_active'] == 5){
                    ...
                    // Formulate the Difference between two dates 
                        ...
                        if ($_SESSION['role_id'] == "1" || $_SESSION['role_id'] == "2") {
                            if($arr['administration_active'] != 5){
                                echo '<a href="dashboard.php?type=update_address&&id=' . base64_encode($arr['user_area_id']) . '&&user_id=' . base64_encode($arr['administration_id']) . '" class="btn btn-success btn-round"> <i class="material-icons" style="margin: 0;">edit</i></a>'; 
                            }
