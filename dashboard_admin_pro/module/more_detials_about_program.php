...
if(isset($_GET['delete']) && isset($_GET['main_id'])){
    ...
    switch ($message_error) {
            ...
            case "Delete":
             // echo "DELETE FROM `program_day_tbl` WHERE `program_day_id` = $Category_ID ";
...
if ($arr['place_id'] == 1) {
  ...
  <tr><td  style="widtd:30%"> ' . $languages['order']['note'] . '</td><td >' . $arr['user_area_notes'] . '</td></tr></table>';
                   ...
                   $.ajax({
                        ...
                        success: function(data, textStatus, jqXHR) {
                            ...
                            if (jsonData.result == "1") {
                                ...
                                setTimeout(function() { window.location.href = "dashboard.php?type=more_detials_about_program&&id=<?php echo $_GET['id']; ?>";}, 3000);
                            } else {
