...
if (isset($_SESSION['user_name']) || isset($_SESSION['password'])) { 
    if (!empty($_POST['RealUserName']) && !empty($_POST['Telephone']) &&  !empty($_POST['program_name']) && ($_POST['program_name'] != "0")) {
        ...
        if ($error) {
            ...
            $user_model->set_user_id($_POST['administration_id']);
            ...
            $query  = "UPDATE `administration_tbl` SET `administration_type_id` = '5', `administration_active` = '1' , `administration_name` = '$RealUserName' , `administration_telephone_number` = '$Telephone', `administration_telephone_number1` = '$Telephone2',`administration_username` = '$UserName' , `administration_password` = '$Password'  WHERE `administration_tbl`.`administration_id` = $_POST[administration_id] ";
           // echo  $query;
         
            $rs     = mysqli_query($con, $query);
            if ($rs) {
                $adminstrator_id = $_POST['administration_id'];
                if ($adminstrator_id > 0) {
                    ...
                    switch ($place_id) {
                        case 1:
                            ...
                            VALUES ('$area_id','$adminstrator_id','$place_id','$_POST[block_number]','$_POST[street_number]','$_POST[avenus_number]','$_POST[house_no]','$_POST[figure]','$_POST[note]','$program_id','$_POST[floor]','$_POST[apart_num]')";
                        ...
                        case 2:
                            ...
                            VALUES ('$area_id','$adminstrator_id',' $place_id','$_POST[block_number]','$_POST[street_number]','$_POST[avenus_number]','$_POST[building_num]','$_POST[floor]','$_POST[apart_num]','$_POST[figure]','$_POST[note]','$program_id')";
                            // echo  $user_area_query ;
                        ...
                        case 3:
                            ...
                            VALUES ('$area_id','$adminstrator_id','$place_id','$_POST[block_number]','$_POST[street_number]','$_POST[avenus_number]','$_POST[building_num]','$_POST[floor]','$_POST[office_num]','$_POST[figure]','$_POST[note]','$program_id')";
                    ...
                    if(empty($_POST['date_start'])){
                        ...
                        $date_model->start_date = date('Y-m-d', strtotime("+1 day", strtotime($_POST['date_start'])));
                    }
