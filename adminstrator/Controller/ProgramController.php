...
class program_controller
{
    ...
    public function insert_program_date()
    {
        ...
        $insert_date_program_query = "INSERT INTO `program_start_end_date_tbl`(`program_start_date`, `program_start_end`, `user_area_id`,`program_active`) 
                                        VALUES('$start_date','$end_date','$program_id','1') ";
