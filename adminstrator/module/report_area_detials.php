...
if(isset($_GET['pro_id'])){
    ...
    if($_SESSION['role_id'] == "1" || $_SESSION['role_id'] == "2" || $_SESSION['role_id'] == "6" || $_SESSION['role_id'] == "3" ) {
?>
...
<div class="col">
  ...
  <option value="6"><?php echo $languages['menu_item']['print_m1']; ?>-Arabic</option>
  <option value="7"><?php echo $languages['menu_item']['print_m2']; ?>-Arabic</option>
</select>                   </p>
