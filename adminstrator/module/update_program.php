   ...
   <div id="Result"></div>
            ...
            <div class="form-group">
                ...
                <input class="form-control" name="dec_title_ar"   value="<?php echo $program_arr['program_ar_describe']; ?>">
                                               ...
                                               <input class="form-control" name="price"  value="<?php echo $program_arr['program_cost']; ?>" id="price" >
                                           </div>
...
<div class="form-group">
                                               ...
                                               <input class="form-control" name="discount"  value="<?php echo $program_arr['program_discount']; ?>" id="discount">
                                           </div>
