...
$languages = array(
    ...
    'area_page' => array( 
        ...
        'order' => ' Order Item : ',
        'All' => 'View All',
        'hold_user' => 'You have to reactive subscriber to add Days ',
    ),
    'menu_item' => array(
        'home'   => 'Home',
        'capitial'   => 'Provinces',
        ...
        'print_m1' => 'Machine Report for mac',
        'print_m2' => 'Machine Report for Windows',
        ...
        'reports' => 'Reports',
        'day'     => 'Reports about day',
        'week'    => 'Reports about Week',
        'month'   => 'Reports',
    ),
    'program' => array(
    ...
    'program_detials' => array(
        ...
        'msg' =>'It is allowed to delete all programs, but if it is only one program, the process of deletion will not be allowed',
